...
#pragma warning("house_e: add update_system voltage adjustment for heating")
	...
	string testcase = "house1A_tm_A_1_652";
	//if (testcase.compare(namebuf) == 0 && (heating_COP>2.5 || cooling_COP>2.7)){
	//printf("house_e heating_COP=%f, heating_load=%f, cooling_COP=%f, cooling_load=%f, hvac_load=%f \n", heating_COP, heating_demand, cooling_COP, cooling_demand, hvac_load);
	//}
}
